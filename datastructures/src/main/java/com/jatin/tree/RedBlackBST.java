...
public class RedBlackBST<Key extends Comparable<Key>, Value> {
    ...
    *****************************************************************************/
    public static void main(String[] args) { 
        ...
        RedBlackBST<String, Integer> redBlackTree = new RedBlackBST<String, Integer>();
...
//        }
        ...
        redBlackTree.put("A", 40);
        redBlackTree.put("B", 30);
        redBlackTree.put("C", 20);
        redBlackTree.put("D", 45);
        redBlackTree.put("E", 50);
        
        for (String s : redBlackTree.keys())
            System.out.println(s + " " + redBlackTree.get(s));
        System.out.println();
    }
}
